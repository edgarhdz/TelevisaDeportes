...
<!-- BEGIN: <Template> --> 
<section class="td_note_videopoll_01"> 
	...
	<div class="main">
		...
		<div class="c2 left">
            ...
            <div class="c2_7">
           		<?php getHtmlComponente("../wdg_poll_video_01/index.html"); ?>
            </div>
            <div class="c2_8 hide-tablet">
            	<?php getHtmlComponente("../art_note_01/index.html"); ?>            	
            </div>
            <div class="c2_9">            	
