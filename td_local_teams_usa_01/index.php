...
$comp[] = 'img_galry_01';
$comp[] = 'btn_progr_03';
$comp[] = 'wdg_team_sched_01';
$comp[] = 'wdg_social_01';
$comp[] = 'wdg_team_leaders_02';
$comp[] = 'wdg_team_teamsts_01';
$comp[] = 'wdg_team_playersts_01';
$comp[] = 'wdg_team_injuries_01';
$comp[] = 'wdg_team_standings_01';
$comp[] = 'wdg_opinion_01';
$comp[] = 'wdg_twitt_02';
$comp[] = 'wdg_poll_01';
$comp[] = 'btn_6prog_02';
...
<!-- BEGIN: <Template> --> 
<section class="td_local_teams_usa_01"> 
	...
	<div class="main">
		...
		<div class="c3">
            ...
            <div class="c3_3 right hide-mobile">  
                <?php getHtmlComponente("../wdg_team_sched_01/index.html",array('link'));?>
            </div>
      ...
      <!--barra lateral 2  parte-->
        <div class="c5">
            <div class="c5_1 left hide-mobile"> 
            	<?php getHtmlComponente("../wdg_team_leaders_02/index.html",array('link'));?> 
            </div>
            <div class="c5_2 right hide-mobile">  
                <?php getHtmlComponente("../wdg_team_standings_01/index.html",array('link'));?>
            </div>
	...
	<!--parte central 2-->
        ...
        <div class="c6">
            <div class="c6_1 hide-mobile">
                <?php getHtmlComponente("../wdg_team_teamsts_01/index.html",array('link'));?>
            </div>
            <div class="c6_2 hide-mobile">
                <?php getHtmlComponente("../wdg_team_playersts_01/index.html",array('link'));?>
            </div>
            <div class="c6_3 hide-mobile">
                <?php getHtmlComponente("../wdg_team_injuries_01/index.html",array('link'));?>
            </div>
        </div>
