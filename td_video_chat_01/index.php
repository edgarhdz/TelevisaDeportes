...
<section class="td_video_chat_01"> 
	...
	<div class="main">
        ...
        <!--Banners-->
        <div class="c1_1 banner_template"></div>
   
		<!--parte central 1-->
		<div class="c2 left hide-tablet">
			<div class="c2_1">
            ...
            <div class="c2_4">
            	<?php getHtmlComponente("../mix_8arts_02/index.html"); ?>
            </div>
            <div class="c2_5">  </div>
            <div class="c2_6">  </div>
            <div class="c2_7">  </div>
		...
		<div class="c3 right hide-tablet">
			<div class="c3_1 left ">			  
				<?php getHtmlComponente("../wdg_video_chat_01/index.html");?>				
            </div>
            ...
            <div class="c3_5 hide-tablet">       </div>
            <div class="c3_6 left hide-mobile">  </div>
            <div class="c3_7 hide-tablet">       </div>
            <div class="c3_8">                   </div>
		</div>
