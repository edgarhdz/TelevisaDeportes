...
<head>
    ...
    <meta charset="utf-8" />
    <!--<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;"> DO NOT ALLOW ZOOM -->
    ...
    <? endif;?>
    <link rel="stylesheet" href="css/<?=COMPONENT?>_tablet.css" media="screen and (min-width: 624px)">
    <link rel="stylesheet" href="css/<?=COMPONENT?>.css" media="screen and (min-width: 948px)">
