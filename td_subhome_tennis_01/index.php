...
?>
<!-- BEGIN: <Template> --> 
<section class="td_subhome_tennis_01"> 
    ...
    <div class="main">
        ...
        <div class="c3">
            ...
            <div class="c3_3 right hide-mobile bottom_space">  
        ...
        <!--Banner 100%-->
        <div class="c6 banner_template hide-tablet bottom_space">
        ...
        <div class="c7 hide-mobile">
            <div class="c7_1">	
				<?php getHtmlComponente("../wdg_tennisresult_01/index.html"); ?>
            </div>
			<div class="c7_2">
