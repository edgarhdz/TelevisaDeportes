...
<!-- BEGIN: <Template> --> 
<section class="td_subhome_fut_01"> 
	...
	<div class="main">
        ...
        <div class="c5">
            <div class="c5_1 left hide-mobile bottom_space"> 
                <img src="../global/img/asamerica.png" alt="Image1" />
            </div>
            <div class="c5_1 right hide-mobile">  
                <?php getHtmlComponente("../wdg_sched_02/index.html");?>
            </div>
            <div class="left double_block">
                <div class="c5_2 left hide-mobile">  
