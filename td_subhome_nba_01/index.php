	...
	<div class="main">
		...
		<div class="c3">
			...
			<div class="c3_3 hide-mobile">  
                <?php getHtmlComponente("../wdg_sport_result_02/index.html");?>
            </div>
        ...
        <div class="c7 hide-mobile left">
			<?php getHtmlComponente("../wdg_sport_standings_01/index.html",array('link')); ?>
			<?php getHtmlComponente("../wdg_nba_leaders_01/index.html",array('link')); ?>
			<?php getHtmlComponente("../wdg_sport_teams_01/index.html"); ?>
		</div>
