...
<!-- BEGIN: wdg_team_sched_01-->
<div class="wdg_team_sched_01" data-enhance="false">
	...
	<div class="scroll">
		<script language="javascript" SRC="http://televisa.stats.com/multisport/stats.js.asp?sport=fb&type=schedrslt&team=23&lang=es"></script>

	</div>
	<div class="degradado"></div>
</div>
<!-- END: wdg_team_sched_01 -->
<?
// footer
