...
<!-- BEGIN: <Template> --> 
<section class="td_subhome_nfl_01"> 
	
    <div class="header1">
        <?php getHtmlComponente("../nav_header_01/index.html"); ?>
		<?php getHtmlComponente("../wdg_teams_carru_03/index.html"); ?>
    </div> 
	...
	<div class="main">
		...
		<div class="c3">
			...
			<div class="c3_2 bottom_space right hide-mobile">  
                <img src="http://placehold.it/300x250" alt="Placebo">
            </div>
			<div class="c3_3 hide-mobile">  
                <?php getHtmlComponente("../wdg_nfl_scoreboard_01/index.html",array('link'));?>
            </div>
		...
		<div class="c6 banner_template bottom_space hide-tablet">
			<img src="http://placehold.it/955x90" alt="banner">
		</div>
		...
		<div class="c5 hide-tablet right">
			<div class="c5_1 hide-tablet left">  
                <?php getHtmlComponente("../wdg_top10_01/index.html");?>
            </div>
			<div class="c5_2 hide-tablet right">
        ...
        <div class="c7 hide-mobile">
			...
			<?php getHtmlComponente("../wdg_nfl_leaders_01/index.html",array('link')); ?>
		...
		<div class="c8 hide-mobile">
			...
			<div class="c8_4 left hide-mobile">  
                <?php getHtmlComponente("../wdg_twitt_02/index.html");?>
            </div>
			<div class="c8_5 hide-tablet">  
                <img src="../global/img/facebook_cmp.png" alt="Facebook" style="margin-bottom:36px;" />
            </div>
			<div class="c8_6 right hide-mobile">  
