	...
	<div class="main">
		...
		<div class="c2">
			...
			<div class="c2_help">
				...
				<div class="c2_1">
					<?php getHtmlComponente("../nav_smnu_video_02/index.html"); ?>
					
				</div>
				<div class="c2_2">
					<img src="http://placehold.it/280x40">
				</div>
	
				<div class="c2_3">
					<?php getHtmlComponente("../vid_player_01c/index.html"); ?>
