...
// cuidar el orden en el que se agregan los scripts
...
$comp[] = 'btn_progr_03';
$comp[] = 'wdg_mlb_sched_01';
$comp[] = 'wdg_social_01';
$comp[] = 'wdg_mlb_leaders_02';
$comp[] = 'wdg_mlb_teamsts_01';
$comp[] = 'wdg_mlb_playersts_01';
$comp[] = 'wdg_mlb_injuries_01';
$comp[] = 'wdg_mlb_standings_01';
$comp[] = 'wdg_opinion_01';
...
<!-- BEGIN: <Template> --> 
<section class="td_local_teams_mlb_01"> 
	...
	<div class="main">
		...
		<div class="c3">
            ...
            <div class="c3_3 right hide-mobile">  
                <?php getHtmlComponente("../wdg_mlb_sched_01/index.html",array('link'));?>
            </div>
	...
	<!--parte central 2-->
        ...
        <div class="c6">
            <div class="c6_1 hide-mobile">
                <?php getHtmlComponente("../wdg_mlb_teamsts_01/index.html",array('link'));?>
            </div>
            <div class="c6_2 hide-mobile">
                <?php getHtmlComponente("../wdg_mlb_playersts_01/index.html",array('link'));?>
            </div>
            <div class="c6_3 hide-mobile">
                <?php getHtmlComponente("../wdg_mlb_injuries_01/index.html",array('link'));?>
            </div>
        </div>
         <div class="c5">
            <div class="c5_1 left hide-mobile"> 
                <?php getHtmlComponente("../wdg_mlb_leaders_02/index.html",array('link'));?> 
            </div>
            <div class="c5_2 right hide-mobile">  
                <?php getHtmlComponente("../wdg_mlb_standings_01/index.html",array('link'));?>
            </div>
